...
Feel free to explore the comments left throughout the HTML and CSS. They
are intentionally written to help you understand the reasoning behind
each section, not just the mechanics. When you add new functionality, try
writing a short comment capturing the intent or business context.

---

*Generated by GitHub Copilot with a focus on teaching professional
